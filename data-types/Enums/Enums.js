...
(function (PrintMedia2) {
    ...
    PrintMedia2[PrintMedia2["Book"] = 4] = "Book"; // 3
...
(function (PrintMedia3) {
    ...
    PrintMedia3[PrintMedia3["Newsletter"] = 5] = "Newsletter";
    PrintMedia3[PrintMedia3["Magazine"] = 5] = "Magazine";
...
*/
var PrintMedia5;
(function (PrintMedia5) {
    PrintMedia5[PrintMedia5["Newspaper"] = 1] = "Newspaper";
    PrintMedia5[PrintMedia5["Newsletter"] = getPrintMediaCode('newsletter')] = "Newsletter";
    PrintMedia5[PrintMedia5["Magazine"] = PrintMedia5.Newsletter * 3] = "Magazine";
    PrintMedia5[PrintMedia5["Book"] = 10] = "Book";
})(PrintMedia5 || (PrintMedia5 = {}));
...
*/
var PrintMedia7;
(function (PrintMedia7) {
    PrintMedia7[PrintMedia7["Newspaper"] = 1] = "Newspaper";
    PrintMedia7[PrintMedia7["Newsletter"] = 2] = "Newsletter";
    PrintMedia7[PrintMedia7["Magazine"] = 3] = "Magazine";
    PrintMedia7[PrintMedia7["Book"] = 4] = "Book";
})(PrintMedia7 || (PrintMedia7 = {}));
console.log(PrintMedia7.Magazine);
console.log(PrintMedia7['Magazine']);
console.log(PrintMedia7[3]);
var MappedPrintMedia;
(function (MappedPrintMedia) {
    MappedPrintMedia[MappedPrintMedia["Newspaper"] = 1] = "Newspaper";
    MappedPrintMedia[MappedPrintMedia["Newsletter"] = 2] = "Newsletter";
    MappedPrintMedia[MappedPrintMedia["Magazine"] = 3] = "Magazine";
    MappedPrintMedia[MappedPrintMedia["Book"] = 4] = "Book";
})(MappedPrintMedia || (MappedPrintMedia = {}));
